...
class LocalString extends Translations {
  final Map<String, String> english = {
    ...
    'question12':
        "In your opinion, please rank the following 11 mindset disciplines (with 1 being the most valuable and 11 being the least valuable) for your own entrepreneurial journey.",
    'skill1': "Acceptance",
    'skill2': "Ambition",
    'skill3': "Autonomy",
    'skill4': "Awareness",
    ...
    'skill9': "Refinement",
    'skill10': "Resilience",
    'skill11': "Responsibility",
    'ranking':"Mindset Ranking",
    'important1':"Not a Priority",
    'important2':"Low Priority",
    'important3':"Priority",
    'important4':"High Priority",
    'important5':"Critical",
    'performance1':"I am terrible at this",
    'performance2':"I am poor at this",
    'performance3':"I am average at this",
    'performance4':"I am good at this",
    'performance5':"I am excellent at this",
    'importantqn':"How important is it that I achieve this?",
    'performanceqn':"How do I rate my performance against this?",
    'next':"Next",
    "previous":"Previous",
  };
  final Map<String, String> japanese = {
    ...
    'question12':
        "以下の11項目のマインドセット要素を、ご自身の起業家精神の向上の観点からランク付けしてください（1が最も価値が高く、11が最も価値が低いとします）。",
    'skill1': "受容性",
    'skill2': "向上心",
    'skill3': "自律性",
    'skill4': "自己認識",
    ...
    'performance1':"とても苦手",
    'performance2':"やや苦手",
    'performance3':"どちらとも言えない",
    'performance4':"得意",
    'performance5':"とても得意",
    'importantqn':"これを達成することが、私自身にとってどれほど重要ですか？",
   'performanceqn':"これに対して自分のパフォーマンスをどのように評価しますか？",
    'next':"次",
    "previous":"前の",
